...
public class TC006_CheckIn_CheckOut_SameDay extends BaseTest {

	@Test
	public static void checkInCheckOutSameDay() throws InterruptedException, IOException {
		
		ReadTestData readTD = new ReadTestData();
		String[] columnNames = { "Destination","CheckIn","CheckOut" };
		ArrayList<String> testdata = readTD.getTestData("Input_TestData", columnNames, "TC006");
